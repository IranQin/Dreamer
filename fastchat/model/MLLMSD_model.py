...
# SD_QFormer
from fastchat.model.LLMSD_QFormer import BertModel
# LLaVA model
from fastchat.llava.model import LlavaLlamaForCausalLM
# CLIP text encoder
...
class LLMSD(LlamaPreTrainedModel):
    ...
    def inference_llm(
        ...
        # type(self.model) -> <class 'fastchat.test.DS_PeftForLoRA.PeftModelForCausalLM'>

...
class ModelArguments:
    ...
    # config for sd
    sd_model_name_or_path: str = "pretrain_ckpt/sd/stable-diffusion-v1-5"
    ...
    SD_QFormer_conversation_33tokens: str = "pretrain_ckpt/Qformer/checkpoint-100000.bin"
    LLaVA_00001: str = "pretrain_ckpt/LLM/LLaVA-7B-v1.1/pytorch_model-00001-of-00002.bin"
    LLaVA_00002: str = "pretrain_ckpt/LLM/LLaVA-7B-v1.1/pytorch_model-00002-of-00002.bin"
    LLaVA_model_path: str = "pretrain_ckpt/LLM/LLaVA-7B-v1.1"
...
class DataArguments:
    ...
    editing_template: str = "fastchat/data/ConversationTemplateMinecraft.txt"

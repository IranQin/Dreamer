...
import transformers
from fastchat.util.dataset import generate_LLaVA_image
import PIL
from SDPipeIP2P_variant1 import SDIP2PPipeline_variant1
from fastchat.model.MLLMSD_model import LLMSD

torch.set_grad_enabled(False)

editing_template = os.path.abspath('fastchat/data/ConversationTemplateMinecraft.txt')
...
def main():
    ...
    if sd_qformer_version == "v1.1-7b":
        ...
        LLaVA_model_path = "pretrain_ckpt/LLM/LLaVA-7B-v1.1"
        LLaVA_00002_weights = "pretrain_ckpt/LLM/LLaVA-7B-v1.1/pytorch_model-00002-of-00002.bin"
        SD_IP2P_path = "pretrain_ckpt/instruct-pix2pix"
    # "v1.1-13b" -> 40005
    elif sd_qformer_version == "v1.1-13b":
        model_name_or_path = "pretrain_ckpt/LLM/Vicuna/vicuna-13b-v1.1"
        LLaVA_model_path = "pretrain_ckpt/LLM/LLaVA-13B-v1.1"
        LLaVA_00002_weights = "pretrain_ckpt/LLM/LLaVA-13B-v1.1/pytorch_model-00002-of-00002.bin"
        SD_IP2P_path = "pretrain_ckpt/instruct-pix2pix"
    ...
    from fastchat.test.PeftForLoRA import PeftModel_for_LLM
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--model_name_or_path",
        type=str,
        default="pretrain_ckpt/LLM/Vicuna/vicuna-7b-v1.1",
    )
    # 2. save_dir
    parser.add_argument(
        '--save_dir',
